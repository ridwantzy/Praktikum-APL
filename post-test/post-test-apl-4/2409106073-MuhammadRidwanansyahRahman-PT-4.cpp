...
int hitungTotalHarga(int harga, int jumlah) {
    ...
    return harga + hitungTotalHarga(harga, jumlah - 1);
}

void tampilkanBarang(int index) {
    if (index >= 0 && index < jumlahBarang) {
        cout << "Nama Barang: " << barang[index].nama << endl;
        cout << "Stok: " << barang[index].detail.stok << endl;
        cout << "Harga: " << barang[index].detail.harga << endl;
    } else {
...
void lihatBarang(string namaBarang) {
                ...
                if (index > 0 && index <= jumlahBarang) {
                    ...
                    if (cin >> jumlahBeli) {
                        if (jumlahBeli > 0 && jumlahBeli <= barang[index - 1].detail.stok) {
                            ...
                            int totalHarga = hitungTotalHarga(barang[index - 1].detail.harga, jumlahBeli);
